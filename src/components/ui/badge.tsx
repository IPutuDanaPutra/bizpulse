...
const badgeVariants = cva(
  // rounded-full (not rounded-4xl / rounded-md) — one shape for every chip/badge in the app, matched
  // explicitly rather than relying on --radius-4xl happening to be large enough to look like a pill (v6 §3.1).
